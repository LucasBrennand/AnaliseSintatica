public class Sintatico1 {
    ...
    public void S(){
        ...
        if(this.token.getTipo() == Token.TIPO_FIM_CODIGO){
            ...
            throw new RuntimeException("Erro! Identificador não reconhecido" +this.token.getLexema());
        }
    }
    private void E(){
        this.T();
    ...
    private void OP(){
        if(this.token.getTipo() == Token.TIPO_OPERADOR_ARITMETICO){
            ...
            throw new RuntimeException("Erro! Operador Aritmético não reconhecido" +this.token.getLexema());
        }
    }
}