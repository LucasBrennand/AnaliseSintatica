public class Token {
    ...
    public static String TIPO_TEXTO[] = {
            "INT", "REAL", "CHAR", "IDENTIFICADOR", "OPERADOR_RELACIONAL", "OPERADOR_ARITMETICO", "CARACTER_ESPECIAL", "PALAVRA_RESERVADA", "OPERADOR_ATRIBUICAO"
    };
